...
public class Brew implements Cloneable {
	...
	/**
	 * Distills all custom potions in the brewer.
	 *
	 ...
	 *
	 * <p>Does not give any guarantees that get() will return notnull for this item, i.e. if it is a brew but the data
	 * is corrupt
	 *
	...
	/**
	 * Loads potion data from data file for backwards compatibility.
	 */
	...
	/**
	 * Removes legacy potion data for an item.
	 */
	...
	/**
	 * Saves all data, Legacy method to save to data file.
	 */
	 ...
	 *
	 * @param recipe Recipe is required if the brew doesn't have a currentRecipe
	 * @param event  Set event to true if a BrewModifyEvent type CREATE should be called and may be cancelled. Only then
	 *               may this method return null
	 * @return The created Item, null if the Event is cancelled
	 */
	 ...
	 *
	 * <p>The meta on the item changes, so to make further changes to the meta, item.getItemMeta() has to be called
	 * again after this
	 *
